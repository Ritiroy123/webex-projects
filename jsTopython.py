   ...
   # refresh_token = 'MTQ2ZmZkNDgtMmI1ZS00ZGYwLTliZWEtNzQwNjRhODVmOGIwOGU2NDVjNDItNGU2_PF84_3bf06e7b-f230-427f-9163-c54d2e428d6a'
    ...
    try:
        ...
        if response.status_code == 403:
            # Handle 403 error, for example, you can log a message or just pass
            pass
        else:
            new_json = {}
            new_json2 = []
            ...
            for item in response.json()['items']:
                #print(response.json())
                if item['name'] == "Webex Video Integration for Microsoft Teams":
                ...
                if item['name'] == "Advanced Space Meetings":
                ...
                if item['name'] == "Webex Meetings Suite":
                ...
                if item['name'] == "Advanced Messaging":
                    # print(item['name'])
            ...
            for key in keys:
                if key.endswith("_Total_Units"):
                    ...
                    if key.startswith("Advanced_Space_Meeting"):
                        ...
                        weightage = 0.10
                    elif key.startswith("Advanced_Messaging"):
                        weightage = 0.25    
